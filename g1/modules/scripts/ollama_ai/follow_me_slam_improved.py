...
class FollowSlamState:
    ...
    def _detect_tick(self, phase: str) -> None:
        ...
        with self.lock:
            ...
            if bool(self.args.prefer_rgb_person) and self.latest_rgb_person_rel is not None and rgb_age <= float(self.args.rgb_person_hold_s):
        ...
        with self.lock:
            ...
            if str(meta.get("source", "")).startswith("rgbd_") and rgb_points.size:
                self.follow_points_rel = rgb_points
            else:
                self.follow_points_rel = self._extract_follow_points(points, rel_x, rel_y, meta)
...
.rc-slider-mark-text, .rc-slider-tooltip-inner { color: #ffffff !important; background: #111827 !important; border: 1px solid #94a3b8 !important; }
