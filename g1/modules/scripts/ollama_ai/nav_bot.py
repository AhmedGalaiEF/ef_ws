...
class NavBotNode(Node):
    ...
    def _extract_go_to_name(low: str) -> str | None:
        patterns = (
            ...
            r"^(?:nach|zu|zum)\s+(?:point|punkt|pukt|pukts|punkts)\s+(.+?)\s+(?:geh|gehe|gehen|fahr|fahre|fahren|lauf|laufe|laufen|navigiere)$",
            r"^(?:nach|zu|zum)\s+(.+?)\s+(?:geh|gehe|gehen|fahr|fahre|fahren|lauf|laufe|laufen|navigiere)$",
            r"^(?:point|punkt|pukt|pukts|punkts)\s+(.+?)\s+(?:geh|gehe|gehen|fahr|fahre|fahren|lauf|laufe|laufen|navigiere)$",
