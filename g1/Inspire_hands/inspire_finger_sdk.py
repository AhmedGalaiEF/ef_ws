...
def move_finger(
    ...
    *,
    ...
    send_angles(hand, finger_target((finger,), percent=percent), speed=speed, force=force, hold=hold)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Move individual fingers on an Inspire hand over Modbus TCP.")
    parser.add_argument(
        "finger",
        type=parse_fingers,
